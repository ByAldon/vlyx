...
// Check for updates (cached in session to prevent lag)
...
<body>
    ...
    <div id="settingsModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <label style="color:#888; font-size:0.8rem;">Email Address</label>
                <input type="email" name="email" value="<?= htmlspecialchars($userData[$user]['email'] ?? '') ?>" style="width:100%; margin:5px 0 5px;">
                <div style="color: #666; font-size: 0.75rem; margin-bottom: 15px;"><i class="fa-solid fa-circle-info"></i> Highly recommended for recovery.</div>
    ...
    <div class="admin-bar">
        ...
        <div class="bar-info">
            Vlyx Hub v<?= $version ?> &bull; <a href="<?= $repo_url ?>" target="_blank" style="color:#555; text-decoration:none;">GitHub</a><br>
            <?php if ($is_outdated): ?>
                <a href="<?= $repo_url ?>" target="_blank" style="color: var(--update); text-decoration: none;"><i class="fa-solid fa-circle-arrow-up"></i> Update available: v<?= htmlspecialchars($_SESSION['latest_version']) ?></a>
            <?php else: ?>

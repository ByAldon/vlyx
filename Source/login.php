...
if (!file_exists('users.json') || empty(json_decode(file_get_contents('users.json'), true))) {
...
<head>
    ...
    <style>
        ...
        input { width: 100%; padding: 15px; margin-bottom: 15px; border-radius: 12px; border: 1px solid #333; background: #23222b; color: white; box-sizing: border-box; font-size: 1rem; }
...
<body>
    ...
    <div class="login-box">
        ...
        <?php if(isset($error)) echo "<p style='color:#ff4444; margin-top:20px;'>$error</p>"; ?>
    </div>
</body>
</html>